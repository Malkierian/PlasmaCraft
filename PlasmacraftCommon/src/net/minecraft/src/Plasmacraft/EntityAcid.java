    ...
    public void onUpdate()
    {
        ...
        if(movingobjectposition != null)
        {
            ...
            } else
            {
                ...
                {
                    worldObj.setBlockWithNotify(k, i1 + 1, k1, PlasmaCraftCore.acidMoving.blockID);
                }
                if(worldObj.isAirBlock(k, i1, k1 + 1))
                {
                    worldObj.setBlockWithNotify(k, i1, k1 + 1, PlasmaCraftCore.acidMoving.blockID);
                }
                if(worldObj.isAirBlock(k, i1, k1 - 1))
                {
                    worldObj.setBlockWithNotify(k, i1, k1 - 1, PlasmaCraftCore.acidMoving.blockID);
                ...
                {
                    worldObj.setBlockWithNotify(k + 1, i1, k1, PlasmaCraftCore.acidMoving.blockID);
                }
                if(worldObj.isAirBlock(k - 1, i1, k1))
                {
                    worldObj.setBlockWithNotify(k - 1, i1, k1, PlasmaCraftCore.acidMoving.blockID);
