...
public abstract class BlockCausticFluids extends Block implements ITextureProvider
{
    ...
    public void onEntityWalking(World world, int i, int j, int k, Entity entity)
    {
        if((entity instanceof EntityPlayer) || (entity instanceof EntityPlayerSP))
        {
            ...
            ItemStack itemstack1 = entityplayer.inventory.armorItemInSlot(2);
            ItemStack itemstack2 = entityplayer.inventory.armorItemInSlot(1);
            ItemStack itemstack3 = entityplayer.inventory.armorItemInSlot(0);
