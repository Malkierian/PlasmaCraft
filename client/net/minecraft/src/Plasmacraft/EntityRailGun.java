...
public class EntityRailGun extends Entity
{
    ...
    public EntityRailGun(World world, EntityLiving entityliving)
    {
        super(world);
        xTile = -1;
        yTile = -1;
    ...
    public void onUpdate()
    {
        ...
        if(movingobjectposition != null)
        {
            ...
            else
            {
                ...
                if(Block.fire.canBlockStay(worldObj, k, i1, k1) && worldObj.isAirBlock(k, i1, k1))
                {
                    worldObj.setBlockWithNotify(k, i1, k1, Block.fire.blockID);
                }
                if(Block.fire.canBlockStay(worldObj, k, i1, k1 + 1) && worldObj.isAirBlock(k, i1, k1 + 1))
                {
                ...
                if(Block.fire.canBlockStay(worldObj, k, i1 + 1, k1) && worldObj.isAirBlock(k, i1 + 1, k1))
                {
                ...
                if(Block.fire.canBlockStay(worldObj, k + 1, i1, k1) && worldObj.isAirBlock(k + 1, i1, k1 ))
                {
                ...
                if(Block.blocksList[inTile] != null && Block.blocksList[inTile].getHardness() > 100)
                {
