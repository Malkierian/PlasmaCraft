...
public class SMRenderLaser extends Render
{

    public SMRenderLaser()
    {
    }

    public void renderArrow(SMEntityLaser entitylaser, double d, double d1, double d2, 
            float f, float f1)
    {
        ...
        float f11 = (float)entitylaser.arrowShake - f1;
        if(f11 > 0.0F)
        {
    ...
    public void doRender(Entity entity, double d, double d1, double d2, 
            float f, float f1)
    {
    	renderArrow((SMEntityLaser)entity, d, d1, d2, f, f1);
    }
}
