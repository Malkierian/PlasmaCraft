...
public class SMEntityCryoBlast extends Entity
{

    public SMEntityCryoBlast(World world)
    {
        super(world);
        xTile = -1;
        yTile = -1;
    ...
    public SMEntityCryoBlast(World world, double d, double d1, double d2)
    {
        super(world);
        xTile = -1;
        yTile = -1;
    ...
    public SMEntityCryoBlast(World world, EntityLiving entityliving)
    {
        super(world);
        xTile = -1;
        yTile = -1;
    ...
    public void onUpdate()
    {
        ...
        if(movingobjectposition != null)
        {
            if(movingobjectposition.entityHit != null)
            {
            	...
            	else if(movingobjectposition.entityHit.attackEntityFrom(DamageSource.causeThrownDamage(this, owner), 1))
                {
            		//TODO CryoBlast
            		SMCryoBlast explosion = new SMCryoBlast(worldObj, this, posX, posY, posZ, 3F);
