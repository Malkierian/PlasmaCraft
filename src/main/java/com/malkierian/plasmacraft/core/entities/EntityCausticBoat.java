...
public class EntityCausticBoat extends EntityBoat
{
	...
	public EntityCausticBoat(World par1World)
	{
		super(par1World);
	}
	
	public EntityCausticBoat(World p_i1705_1_, double p_i1705_2_, double p_i1705_4_, double p_i1705_6_)
	{
		super(p_i1705_1_, p_i1705_2_, p_i1705_4_, p_i1705_6_);
	}
    ...
    public boolean attackEntityFrom(DamageSource p_70097_1_, float p_70097_2_)
    {
        ...
        else if (!this.worldObj.isRemote && !this.isDead)
        {
            ...
            if (flag || this.getDamageTaken() > 40.0F)
            {
                ...
                if (!flag)
                {
                    this.func_145778_a(PlasmaCraft.causticBoat, 1, 0.0F);
                }
        ...
        else
        {
            ...
            if (this.isCollidedHorizontally && d10 > 0.2D)
            {
                if (!this.worldObj.isRemote && !this.isDead)
                {
                    ...
                    for (l = 0; l < 3; ++l)
                    {
                        this.func_145778_a(PlasmaCraft.ingotRadionite, 1, 0.0F);
                    }
                }
            }
            else
