...
//        {
//            int i1 = par1World.getBlock(par2, par3, par4);
//
//            if (i1 > 0)
//            {
...
//    {
//        int l = par1World.getBlock(par2, par3, par4);
//
//        if (l != Blocks.wooden_door && l != Blocks.iron_door && l != Blocks.standing_sign || i == Blocks.wall_sign && l != Blocks.ladder && l != Blocks.reeds)
//        {
//            if (l == 0)
//            {
//                return false;
...
//
//        if (par1World.getBlock(par2, par3, par4) == this.blockID)
//        {
//            par1World.scheduleBlockUpdate(par2, par3, par4, this.blockID, this.tickRate(par1World));
//        }
//    }
