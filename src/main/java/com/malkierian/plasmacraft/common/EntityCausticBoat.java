...
public class EntityCausticBoat extends Entity
{
	...
	public EntityCausticBoat(World par1World, double par2, double par4, double par6)
	{
		this(par1World);
	...
	public boolean attackEntityFrom(DamageSource par1DamageSource, int par2)
	{
		...
		else if (!this.worldObj.isRemote && !this.isDead)
		{
			...
			if (this.getDamageTaken() > 40)
			{
				...
				this.dropItem(PlasmaCraft.causticBoat, 1);
				this.setDead();
			}
		...
		else
		{
			...
			if (this.isCollidedHorizontally && var24 > 0.2D)
			{
				if (!this.worldObj.isRemote)
				{
					...
					{
						this.dropItem(PlasmaCraft.ingotRadionite, 1);
					}
				}
			}
			else
			...
			if (!this.worldObj.isRemote)
			{
				...
				for (var27 = 0; var27 < 4; ++var27)
				{
					...
					for (int var20 = 0; var20 < 2; ++var20)
					{
						...
						{
							Blocks.waterlily.dropBlockAsItemWithChance(this.worldObj, var28, var21, var19, var23, 0.3F, 0);
							this.worldObj.setBlockToAir(var28, var21, var19);
						}
					}
				}
