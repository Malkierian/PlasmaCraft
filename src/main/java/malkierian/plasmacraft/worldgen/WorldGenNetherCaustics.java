...
public class WorldGenNetherCaustics extends WorldGenerator
{
	...
	public boolean generate(World world, Random random, int i, int j, int k)
	{
		...
		if(world.getBlockState(pos.add(0, 1, 0)).getBlock() != Blocks.NETHERRACK)
		{
			return false;
		}
		if(world.getBlockState(pos.add(0, -1, 0)).getBlock() != Blocks.NETHERRACK)
		...
		int l = 0;
		if(world.getBlockState(pos.add(-1, 0, 0)).getBlock() == Blocks.NETHERRACK)
		{
			l++;
		}
		if(world.getBlockState(pos.add(1, 0, 0)).getBlock() == Blocks.NETHERRACK)
		...
		if(world.getBlockState(pos.add(0, 0, -1)).getBlock() == Blocks.NETHERRACK)
		{
			l++;
		}
		if(world.getBlockState(pos.add(0, 0, 1)).getBlock() == Blocks.NETHERRACK)
