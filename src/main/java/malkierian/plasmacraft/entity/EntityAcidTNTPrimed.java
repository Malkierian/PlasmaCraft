...
import malkierian.plasmacraft.world.AcidExplosion;
...
public class EntityAcidTNTPrimed extends Entity
{
    ...
    public EntityAcidTNTPrimed(World worldIn)
    {
        super(worldIn);
        this.fuse = 80;
    ...
    public EntityAcidTNTPrimed(World worldIn, double x, double y, double z, EntityLivingBase igniter)
    {
        this(worldIn);
    ...
    {
		float f = 10F;
		AcidExplosion explosion = new AcidExplosion(worldObj, null, posX, posY, posZ, f, false, true);
