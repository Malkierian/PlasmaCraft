...
public class CausticExplosion extends Explosion
{
    /** whether or not the explosion sets fire to blocks around it */
    protected final boolean isFlaming;
    /** whether or not this explosion spawns smoke particles */
    protected final boolean isSmoking;
    protected final Random explosionRNG;
    protected final World worldObj;
    protected final double explosionX;
    protected final double explosionY;
    protected final double explosionZ;
	...
	public CausticExplosion(World worldIn, Entity entityIn, double x, double y, double z, float size, boolean flaming, boolean smoking)
	{
