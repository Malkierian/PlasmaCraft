...
public class SMEntityAcid extends Entity
{

    public SMEntityAcid(World world)
    {
        super(world);
        xTile = -1;
        yTile = -1;
    ...
    public SMEntityAcid(World world, double d, double d1, double d2)
    {
        super(world);
        xTile = -1;
        yTile = -1;
    ...
    public SMEntityAcid(World world, EntityLiving entityliving)
    {
        super(world);
        xTile = -1;
        yTile = -1;
    ...
    public void onUpdate()
    {
        ...
        if(movingobjectposition != null)
        {
            ...
            if(movingobjectposition.entityHit != null)
            {
            	...
            	else if(movingobjectposition.entityHit.attackEntityFrom(DamageSource.causeThrownDamage(this, owner), 6))
                {
            	...
            	{
            		worldObj.setBlockWithNotify(i, j + 1, k, mod_PlasmaCraft.acidMoving.blockID);		
            	}
            	
            	if(worldObj.isAirBlock(i, j , k + 1))
            	{
            		worldObj.setBlockWithNotify(i, j, k + 1, mod_PlasmaCraft.acidMoving.blockID);		
            	}
            	if(worldObj.isAirBlock(i, j , k - 1))
            	{
            		worldObj.setBlockWithNotify(i, j, k - 1, mod_PlasmaCraft.acidMoving.blockID);		
            	...
            	{
            		worldObj.setBlockWithNotify(i + 1, j, k, mod_PlasmaCraft.acidMoving.blockID);		
            	}
            	if(worldObj.isAirBlock(i - 1, j , k))
            	{
            		worldObj.setBlockWithNotify(i - 1, j, k, mod_PlasmaCraft.acidMoving.blockID);		
