...
public class SMEntityRailGun extends Entity
{

    public SMEntityRailGun(World world)
    {
        super(world);
        xTile = -1;
        yTile = -1;
    ...
    public SMEntityRailGun(World world, double d, double d1, double d2)
    {
        super(world);
        xTile = -1;
        yTile = -1;
    ...
    public SMEntityRailGun(World world, EntityLiving entityliving)
    {
        super(world);
        xTile = -1;
        yTile = -1;
        ...
        setArrowHeading(motionX, motionY, motionZ, 10.0F, 1.0F);
    }
            ...
            float f1)
    {
        ...
        d1 /= f2;
        d2 /= f2;
        d += rand.nextGaussian() * 0.0000999998323619366D * (double)f1;
        d1 += rand.nextGaussian() * 0.0000999998323619366D * (double)f1;
        d2 += rand.nextGaussian() * 0.0000999998323619366D * (double)f1;
        d *= f;
        d1 *= f;
        d2 *= f;
        motionX = d;
    ...
    public void onUpdate()
    {
        ...
        if(movingobjectposition != null)
        {
            ...
            if(movingobjectposition.entityHit != null)
            {
            	...
            	else if(movingobjectposition.entityHit.attackEntityFrom(DamageSource.causeThrownDamage(this, owner), 12))
                {
