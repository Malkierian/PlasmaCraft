...
public class SMBlockPlasmificator extends BlockContainer
{
    ...
    {
        //ModLoader.OpenGUI(entityplayer, 159, (SMTileEntityPlasmaBench)world.getBlockTileEntity(i, j, k), new SMContainerPlasmaBench(entityplayer.inventory, (SMTileEntityPlasmaBench)world.getBlockTileEntity(i, j, k)));
        SMTileEntityPlasmaBench tile = (SMTileEntityPlasmaBench)world.getBlockTileEntity(i, j, k);
        ModLoader.OpenGUI(entityplayer, 159, tile, new SMContainerPlasmaBench(entityplayer.inventory, tile));
        return true;
     }
