...
public class SMEntityLaser extends Entity
{

    public SMEntityLaser(World world)
    {
        super(world);
        xTile = -1;
        yTile = -1;
    ...
    public SMEntityLaser(World world, double d, double d1, double d2)
    {
        super(world);
        xTile = -1;
        yTile = -1;
    ...
    public SMEntityLaser(World world, EntityLiving entityliving)
    {
        super(world);
        xTile = -1;
        yTile = -1;
        ...
        if(movingobjectposition != null)
        {
            if(movingobjectposition.entityHit != null)
            {
            	...
            	if (!worldObj.singleplayerWorld)
            	{
                    ...
                    {
                        worldObj.setBlockWithNotify(i, j, k, 0);
                        dropItem(mod_PlasmaCraft.goopNeptunium.shiftedIndex,1);
                        willplacefire = 0;
                    }*/
                	if(worldObj.getBlockId(i, j, k) == mod_PlasmaCraft.oreRadionite.blockID)
                    {
                        worldObj.setBlockWithNotify(i, j, k, 0);
