...
public class SMEntityPlasma extends Entity
{

    public SMEntityPlasma(World world)
    {
        super(world);
        xTile = -1;
        yTile = -1;
    ...
    public SMEntityPlasma(World world, double d, double d1, double d2)
    {
        super(world);
        xTile = -1;
        yTile = -1;
    ...
    public SMEntityPlasma(World world, EntityLiving entityliving)
    {
        super(world);
        xTile = -1;
        yTile = -1;
        ...
        if(movingobjectposition != null)
        {
            if(movingobjectposition.entityHit != null)
            {
            	...
            	else if(movingobjectposition.entityHit.attackEntityFrom(DamageSource.causeThrownDamage(this, owner), 6))
                {
                	...
                	if (mod_PlasmaCraft.PlasmaRifleCreatesFire == 1){
                    ...
                    if (randomInt == 1) 
                    {
                    	if (mod_PlasmaCraft.PlasmaRifleCreatesExplosions == 1){
                		System.out.println("Acid explosion!");
                		SMAcidExplosion explosion = new SMAcidExplosion(worldObj, this, posX, posY, posZ, 3F);
