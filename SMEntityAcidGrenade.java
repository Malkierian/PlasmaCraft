...
public class SMEntityAcidGrenade extends Entity
{

    public SMEntityAcidGrenade(World world)
    {
        super(world);
        xTileSnowball = -1;
        yTileSnowball = -1;
    ...
    public SMEntityAcidGrenade(World world, EntityLiving entityliving)
    {
        super(world);
        xTileSnowball = -1;
        yTileSnowball = -1;
    ...
    public SMEntityAcidGrenade(World world, double d, double d1, double d2)
    {
        super(world);
        xTileSnowball = -1;
        yTileSnowball = -1;
