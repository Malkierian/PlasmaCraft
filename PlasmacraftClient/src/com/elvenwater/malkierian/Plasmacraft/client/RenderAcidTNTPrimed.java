...
public class RenderAcidTNTPrimed extends Render
{
    ...
    public void renderPrimedTNT(EntityAcidTNTPrimed par1EntityTNTPrimed, double par2, double par4, double par6, float par8, float par9)
    {
        GL11.glPushMatrix();
    ...
    {
        this.renderPrimedTNT((EntityAcidTNTPrimed)par1Entity, par2, par4, par6, par8, par9);
    }
}
