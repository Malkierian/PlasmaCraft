...
public class WorldGenerator implements IWorldGenerator {
	...
	private void generateNether(World world, Random random, int i, int j)
	{
		for(int k = 0; k < PlasmaCraft.neptuniumOreVeinCount; k++)
        {
            ...
            (new WorldGenNetherMinable(PlasmaCraft.oreBlockID, PlasmaCraft.neptuniumOreVeinSize, PlasmaCraft.neptuniumMeta)).generate(world, random, l1, i3, j4);
        }
        ...
        for(int l = 0; l < PlasmaCraft.obsidiumOreVeinCount; l++)
        {
            ...
            (new WorldGenNetherMinable(PlasmaCraft.oreBlockID, PlasmaCraft.obsidiumOreVeinSize, PlasmaCraft.obsidiumMeta)).generate(world, random, i2, j3, k4);
        }
