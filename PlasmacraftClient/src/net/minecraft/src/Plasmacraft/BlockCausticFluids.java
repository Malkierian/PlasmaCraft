...
public abstract class BlockCausticFluids extends Block implements ITextureProvider
{
    ...
    public void onEntityWalking(World world, int i, int j, int k, Entity entity)
    {
        if((entity instanceof EntityPlayer) || PlasmaCraftCore.proxy.getEntityInstanceOf(entity))
        {
            ...
            boolean flag = itemstack[0].itemID == PlasmaCraftCore.hazmatHood.shiftedIndex;
            boolean flag1 = itemstack[1].itemID == PlasmaCraftCore.hazmatJacket.shiftedIndex;
            boolean flag2 = itemstack[2].itemID == PlasmaCraftCore.hazmatPants.shiftedIndex;
            boolean flag3 = itemstack[3].itemID == PlasmaCraftCore.hazmatBoots.shiftedIndex;
